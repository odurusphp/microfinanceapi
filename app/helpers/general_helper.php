...
function textazubi($telephone){
   // $mestelephone = '233'.$telephone;
    $message = 'Hello Azubi Prospect, your online interview is on Thursday 4th June. Check your inbox or spam for the invitation mail. Kindly send a mail to adea.natchiah-blay@azubiafrica.org or gideon.sackey@azubiafrica.org if you have not received any mail. Thank you.';
